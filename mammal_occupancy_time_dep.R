...
# Full time dependent occupancy analysis 
...
raccoon.time.umf = unmarkedMultFrame(y = raccoon.dat[28:48], 
                                          siteCovs = raccoon.dat[1:27], 
...
opossum.time.umf = unmarkedMultFrame(y = opossum.dat[28:48], 
                                      siteCovs = opossum.dat[1:27], 
                                      yearlySiteCovs = list(year = survey.years), 
                                      numPrimary = 3)
...
squirrel.time.umf = unmarkedMultFrame(y = squirrel.dat[28:48], 
                                          yearlySiteCovs = list(year = survey.years), 
                                          numPrimary = 3)
...
cotton.mouse.time.umf = unmarkedMultFrame(y = cotton.mouse.dat[28:48], 
                                          yearlySiteCovs = list(year = survey.years), 
                                          numPrimary = 3)
